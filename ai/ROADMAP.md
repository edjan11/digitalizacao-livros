...
| **M4** | Quality Audit background | Já em background (filas `scan_screen.py`) | **Concluído (2026-08-16)**: painel "Conferir livro" (resumo, filtros, cartões, recaptura, marcar conferido) — UX decidida com o operador |
